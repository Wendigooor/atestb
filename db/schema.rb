...
ActiveRecord::Schema.define(version: 20140301092942) do
  ...
  add_index "clicks", ["created_at"], name: "index_clicks_on_created_at", using: :btree
  ...
  add_index "users", ["macaddress"], name: "index_users_on_macaddress", using: :btree
