$(document).on "click", ".after_campaign_purchase", (event) ->
  event.preventDefault()
  purchase = $(this).parent().find('input')
  campaign_id = $(this).parent().find('input').attr('class')
  $.ajax
    type: "POST"
    url: $(this).attr "href"
    ...
    success: (data) ->
      ...
      $("div.campaign_purchased").text("Total campaign purchased: " + data.campaign_purchased)
