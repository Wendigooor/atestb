...
(function() {
  $(document).on("click", ".add_credits", function(event) {
    var client_id;
    event.preventDefault();
    ...
    return $.ajax({
      ...
      error: function(data) {
        ...
        return $("#current_balance").text("Your balance is " + data.balance + " credits");
      },
...
(function() {
  $(document).on("click", ".purchase", function(event) {
    ...
    return $.ajax({
      ...
      dataType: "json",
      error: function(data) {
        return alert("Purchase response error: status: " + data.status + " reason: " + data.reason + " balance: " + data.balance);
      },
      success: function(data) {
        $("#current_balance").text("Your balance is " + data.balance + " credits");
        $("div." + campaign_id + "purchased").text(data.campaign_purchased);
        return $("#purchase_reason").text(data.reason);
      }
    });
  });
